    ...
    <NavBar>
      <div className="bg-[#222222]">
        <div class="flex justify-center rounded-b-3xl bg-[#e12f3b] text-white">
          {/* //! navBar */}
          <div class="grid md:grid-cols-2  grid-cols-1 md:w-[120ch] h-auto px-[16px] gap-[24px] py-[24px] lg:h-[60vh] justify-center items-center mt-[64px]">
            <div class="flex flex-col gap-[24px] mt-[64px]">
              ...
              <a
                href="#"
                class="bg-gray-800 text-white py-2 px-4 rounded-[8px] hover:bg-red-700 w-fit "
              >
                ...
                <div class="">
                  <ul class="space-y-4 flex flex-col gap-[16px]">
                    <li>
                      ...
                      kbps.
                      <br />- Content must be original, free from plagiarism,
                    ...
                    <li>
                      ...
                      licensing agreement for their content. <br />- Content
                      must be free from any third-party claims or restrictions.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      Metadata fields required include title, author,
                      description, keywords, and cover image.
                    </li>
                    <li>
                      <strong>Marketing and Promotion:</strong> <br />
                      - Partners are encouraged to promote their content on
                      social media and other channels. <br />- The platform will
                      provide marketing support, such as featured listings and
                      email campaigns.
                    </li>
                    <li>
                      <strong>Payment Terms:</strong> <br />
                      - Partners will receive a commission of [percentage] on
                      each sale of their e-books or audiobooks. <br />- Payments
                      will be made [frequency] using [payment method].
                    </li>
                  </ul>
                </div>
                {/* <!-- Image --> */}
